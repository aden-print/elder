    ...
    <body>
        ...
        <header id="head" class="secondary">
            <div class="container">
                ...
                <p>Por favor, complete el siguiente formulario para inscribir a su apoderado/hijo en nuestro sistema. Proporcione la información
                    requerida.</p>
            </div>
        </header>
        <!-- container -->
        <div class="container">
            <div class="row">
                ...
                %>
                <br>
                <h4>Debe iniciar sesión primero para poder inscribir alumnos.</h4>
                ...
                <div class="col-md-8">
                    <br>
                    <form class="form-light mt-20" role="form" action="InscripcionServlet" method="post">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="apellidos" placeholder="Apellidos del alumno" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nombres del alumno:</label>
                                    <input type="text" class="form-control" name="nombres" placeholder="Nombres del alumno" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Institución de procedencia (Dejar vacio si es su primera vez):</label>
                                    <input type="text" class="form-control" name="institucionProcedencia" placeholder="Institución de procedencia" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Condición médica (Opcional):</label>
                                    <input type="text" class="form-control" name="condicionMedica" placeholder="Condición médica del alumno">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Número de contacto de emergencia:</label>
                                    <input type="text" class="form-control" name="telefonoEmergencia" placeholder="Número de teléfono de emergencia" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nombre del contacto de emergencia:</label>
                                    <input type="text" class="form-control" name="nombreContactoEmergencia" placeholder="Nombre del contacto de emergencia" required>
                                </div>
                            </div>
                            <input type="hidden" id="estado" name="estado" value="0">
                        </div>
                        <button type="submit" class="btn btn-two" name="enviar">Guardar Inscripción</button><p><br/></p>
                    </form>
                </div>
                <% }%>
            </div>
