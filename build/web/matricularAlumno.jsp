    ...
    <body>
        ...
        <header id="head" class="secondary">
            <div class="container">
                ...
                <p>Por favor, seleccione uno de sus hijos y/o apoderados inscritos para matricular.</p>
            </div>
        </header>
        <!-- container -->
        <div class="container">
            <div class="row">
                ...
                %>
                <br>
                <h4>Debe iniciar sesión primero para poder matricular alumnos.</h4>
                <%
                } else {
                %>
                <h1 class="mt-5">Tus hijos y/o apoderados inscritos en el sistema:</h1>
                    ...
                    <tbody>
                        <c:forEach var="alumnos" items="${alumnos}">
                            <tr>
                                ...
                                <td>${alumnos.institucionProcedencia}</td>
                                <td>${alumnos.nombreContactoEmergencia}</td>
                                <td>${alumnos.telefonoEmergencia}</td>
                                <td>${alumnos.condicionMedica}</td>
                                <td>
                                    <c:choose>
                                        <c:when test="${alumnos.estado == 1}">
                                            Matriculado
                                        </c:when>
                                        <c:otherwise>
                                            No matriculado
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${alumnos.estado == 0}">
                                            <a href="frmMatricula.jsp?id=${alumnos.idAlumno}&dni=${alumnos.dni}&apellidos=${alumnos.apellidos}&nombres=${alumnos.nombres}" class="btn btn-primary">Matricular</a>
                                        </c:when>
                                        <c:otherwise>
                                            <!-- No se muestra el botón si el estado es 1 -->
                                        </c:otherwise>
                                    </c:choose>
                                </td>
                            </tr>
