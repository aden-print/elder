    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav pull-right mainNav">
                        ...
                        <li class="active"><a href="costos.jsp">Nuestros Costos</a></li>
        ...
        <header id="head" class="secondary">
            <div class="container">
                ...
                <p>El precio está adaptado para los diferentes bolsillos de los padres de familia y/o apoderados.</p>
            </div>
        </header>
        <section class="container">
            <div class="heading">
                ...
                <p>Contamos desde la educación inicial hasta la educación pre-universitaria.</p>
                <br />
            </div>
            <div class="row flat">
                <div class="col-lg-3 col-md-3 col-xs-6">
                    <ul class="plan plan1">
                        <li class="plan-name">Inicial
                        </li>
                        <li class="plan-price">
                            <strong>S/. 200</strong> Inscripción (Pago único)
                        </li>
                        <li>
                            <strong>S/. 150</strong> Matrícula (Pago único)
                        </li>
                        <li>
                            <strong>S/. 150</strong> Gastos Administrativos (Pago único)
                        </li>
                        <li>
                            <strong>S/. 250</strong> Pensión (Mensual)
                        </li>
                ...
                <div class="col-lg-3 col-md-3 col-xs-6">
                    <ul class="plan plan2">
                        ...
                        <li>
                            <strong>S/. 350</strong> Pensión (Mensual)
                        </li>
                        <li class="plan-action">
                            <a href="matriculate.jsp" class="btn">Acceder</a>
                        </li>
                ...
                <div class="col-lg-3 col-md-3 col-xs-6">
                    <ul class="plan plan4">
                        <li class="plan-name">Pre-Universitario
                        </li>
                        <li class="plan-price">
                            <strong>S/. 200</strong> Inscripción (Pago único)
                        </li>
                        ...
                        <li>
                            <strong>S/. 200</strong> Pensión (Mensual)
                        </li>
                        <li class="plan-action">
                            <a href="matriculate.jsp" class="btn">Acceder</a>
                        </li>
